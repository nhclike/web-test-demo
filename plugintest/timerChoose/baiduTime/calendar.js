window.calendar = (function() {
    ...
    return {
        init: function(options){
            options.cellClickCallback=options.cellClickCallback || defaultOptions.cellClickCallback;

            options.yearSelectId=options.yearSelectId || defaultOptions.yearSelectId;
            options.monthSelectId=options.monthSelectId || defaultOptions.monthSelectId;
            options.heavenlyId=options.heavenlyId || defaultOptions.heavenlyId;
            options.branchId=options.branchId || defaultOptions.branchId;
            options.prevId=options.prevId || defaultOptions.prevId;
            options.nextId=options.nextId || defaultOptions.nextId;
            options.nowDateId=options.yearSelectId || defaultOptions.nowDateId;
            options.isSelect=options.isSelect || defaultOptions.isSelect;
            options.isHeavenlyBranch=options.isHeavenlyBranch || defaultOptions.isHeavenlyBranch;
            options.isShowFd=options.isShowFd || defaultOptions.isShowFd;
            opt = options;
