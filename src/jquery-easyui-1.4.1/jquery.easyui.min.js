...
(function( $ ) {
	$.parser = {
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree",
				"textbox", "filebox", "combo", "combobox", "combotree", "combogrid", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner",
				"timespinner", "datetimespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid",
								...
								if (_a7 == "last") {
									...
									if (_a7 == "manual") {
										...
										bb.num.unbind(".pagination").bind("keydown.pagination", function( e ) {
											// modify by 26007 at 20160803；翻页输入框仅限输入数字、回退、DEL
											if (e.keyCode == 8 || e.keyCode == 46 || e.keyCode == 110 || (e.keyCode >= 49 && e.keyCode <= 57) || (e.keyCode >= 96 && e.keyCode <= 105)){
...
(function( $ ) {
	...
	function _20f( _210 ) {
		...
		function _213() {
			...
			if (opts.title && !opts.noheader) {
				...
				// }
				// 修改对话框样式，方舟
				var _218 = $("<div class=\"panel-title\"></div>").appendTo(_217);
				$("<span class=\"panel-title-span\"></span>").html(opts.title).appendTo(_218);
				$("<div class=\"panel-right\"></div>").appendTo(_217);
				if (opts.iconCls) {
					_218.addClass("panel-with-icon");
		...
		doLayout : function( jq, all ) {
			return jq.each(function() {
				...
				function _24f( _250, type ) {
					...
					var s = $(_250).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(
							function( _252, el ) {
	...
	$.fn.panel.parseOptions = function( _256 ) {
		var t = $(_256);
		return $.extend({}, $.parser.parseOptions(_256, [ "id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools",
				"href", "method", {
					cache : "boolean",
					fit : "boolean",
					border : "boolean",
...
(function( $ ) {
	function _25f( _260, _261 ) {
		...
		if (_262.shadow) {
			/**
			 * 将iframe-mask随着窗体一起移动
			 * 
			 * @author 26007
			 * @date 20150312
			 */
			_262.mask_iframe.css({
	...
	function _26d( _26e ) {
		...
		var win = $(_26e).panel($.extend({}, _26f.options, {
			...
			onOpen : function() {
				if (_26f.shadow) {
					/**
					 * 添加iframe-mask，使窗体浮动于OCX控件之上
					 * 
					 * @author 26007
					 * @date 20150312
					 */
					_26f.mask_iframe.css({
						display : "block",
		...
		if (opts.shadow == true) {
			/** ���iframe-mask */
			_26f.mask_iframe = $("<iframe class=\"window-shadow window-mask-iframe\" src=\"javascript:false\"></iframe>").insertAfter(_26f.window);
			_26f.mask_iframe.css({
				display : "none",
				visibility : "inherit",
				opacity : 0
	...
	function _274( _275 ) {
		...
		_276.window.draggable({
			...
			onStartDrag : function( e ) {
				if (_276.options.modal == false && !_276.mask) {
					_276.mask = $("<div class=\"window-mask\"></div>").insertAfter(_276.window);
					_276.mask.css({
						width : (_276.options.inline ? _276.mask.parent().width() : _273().width),
						height : (_276.options.inline ? _276.mask.parent().height() : _273().height),
						display : "block"
					});
				}
				if (_276.mask) {
				...
				if (_276.shadow) {
					_276.mask_iframe.css("z-index", $.fn.window.defaults.zIndex++);
...
(function( $ ) {
		...
		if (opts.buttons) {
			if ($.isArray(opts.buttons)) {
				...
				for ( var i = 0; i < opts.buttons.length; i++) {
					...
					var _283 = $("<a href=\"#\"></a>").appendTo(_282);
					if (p.handler) {
	...
	function _284( _285, _286 ) {
		 ...
		 * @since 20150312
		 */
		var _mask_iframe = $.data(_285, "window").mask_iframe;
		if (_mask_iframe) {
			var cc = t.panel("panel");
			_mask_iframe.css({
				width : cc._outerWidth(),
...
(function( $ ) {
	function show( el, type, _290, _291 ) {
		...
		var _shadow = $.data(el, "window").shadow;
		var _mask_iframe = $.data(el, "window").mask_iframe;
		_mask_iframe.css({
			display : "block",
			width : win.width(),
			height : win.height()
		...
		switch (type) {
			...
			case "slide":
				if (_mask_iframe) {
					_mask_iframe.animate({
						bottom : 0
					}, 350);
				}
				if (_shadow) {
					_shadow.slideDown(_290);
				}
				win.slideDown(_290, function() {
					/**
					 * 淡出之后，变更位置，宽，高
					 * 
					 * @author 26007
	...
	function _294( _295 ) {
		...
		var _shade_index = $.fn.window.defaults.zIndex++;
		var _mask_index = $.fn.window.defaults.zIndex++;
		...
		var _windata = $.data(win[0], "window");
		_windata.shadow.css({
			display : "none",
			zIndex : _shade_index
		});
		var iframecss = $.extend({
			display : "block",
			width : 250,
			height : 100,
			left : "",
			...
			top : opts.style.top,
			right : opts.style.right
		});
		_windata.mask_iframe.css(iframecss);
		
		/*_windata.mask_iframe.css({
			display : "block",
			width : 250,
			height : 100,
			left : 0,
	...
	function _296( _297, _298, _299 ) {
		...
		if (_299) {
			...
			for ( var _29a in _299) {
				$("<a></a>").attr("href", "#").text(_29a).css("margin-left", 10).bind("click", eval(_299[_29a])).appendTo(tb).linkbutton();
			}
		}
		win.window({
			title : _297,
	...
	$.messager = {
		...
		prompt : function( _2a2, msg, fn ) {
			var _2a3 = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>"
	...
	function _309( _30a ) {
		...
		if (opts.tools) {
			if (typeof opts.tools == "string") {
				...
				var _30c = $("<div class=\"tabs-tool\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>")
						.appendTo(_30b);
				var tr = _30c.find("tr");
				for ( var i = 0; i < opts.tools.length; i++) {
					var td = $("<td></td>").appendTo(tr);
	...
	function _31b( _31c ) {
		...
		$(
				"<div class=\"tabs-header\">" + "<div class=\"tabs-scroller-left\"></div>" + "<div class=\"tabs-scroller-right\"></div>"
						+ "<div class=\"tabs-wrap\">" + "<ul class=\"tabs\"></ul>" + "</div>" + "</div>").prependTo(_31c);
	...
	function _38b( _38c, _38d, el ) {
		...
		var _38f = $.extend({}, $.fn.layout.paneldefaults, {
			...
			onOpen : function() {
				...
				if (!t.length) {
					t = $("<a href=\"#\"></a>").addClass(_391).appendTo(tool);
					t.bind("click", {
						dir : dir
					}, function( e ) {
	...
	function _3dd( _3de, _3df ) {
		...
		menu.show(0, function() {
			if (!menu[0].shadow) {
				...
				menu[0].mask_iframe = $("<iframe id=\"menu-iframe\" class=\"menu\"></iframe>").insertAfter(menu);
			}
			menu[0].mask_iframe.css({
				display : "block",
...
(function( $ ) {
	function init( _45b ) {
		...
		var span = $(
				"<span class=\"textbox\">" + "<input class=\"textbox-text\" autocomplete=\"off\">" + "<input type=\"hidden\" class=\"textbox-value\">"
	...
	function _45c( _45d ) {
		...
		if (bb.length) {
			...
			for ( var i = 0; i < bb.length; i++) {
				bc.append("<a href=\"#\" class=\"textbox-icon " + bb[i].iconCls + "\" icon-index=\"" + i + "\" tabindex=\"-1\"></a>");
			}
		}
	...
	$.fn.textbox.parseOptions = function( _494 ) {
		var t = $(_494);
		return $.extend({}, $.fn.validatebox.parseOptions(_494), $.parser.parseOptions(_494, [ "prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon",
				"buttonAlign", {
					multiline : "boolean",
					editable : "boolean",
					iconWidth : "number"
...
(function( $ ) {
	...
	function _4ce( _4cf ) {
		_4cf.reset();
		var t = $(_4cf);
		var _4d0 = [ "textbox", "combo", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "spinner", "timespinner", "numberbox",
	...
	function init( _4fb ) {
		$(_4fb).addClass("calendar").html(
				"<div class=\"calendar-header\">" + "<div class=\"calendar-nav calendar-prevmonth\"></div>"
						...
						+ "<div class=\"calendar-nav calendar-nextyear\"></div>" + "<div class=\"calendar-title\">" + "<span class=\"calendar-text\"></span>"
						+ "</div>" + "</div>" + "<div class=\"calendar-body\">" + "<div class=\"calendar-menu\">" + "<div class=\"calendar-menu-year-inner\">"
						+ "<span class=\"calendar-nav calendar-menu-prev\"></span>" + "<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>"
						+ "<span class=\"calendar-nav calendar-menu-next\"></span>" + "</div>" + "<div class=\"calendar-menu-month-inner\">" + "</div>"
						+ "</div>" + "</div>");
...
(function( $ ) {
	function _529( _52a ) {
		...
		_52e.append("<a href=\"#\" class=\"spinner-arrow-up\" tabindex=\"-1\"></a>");
		_52e.append("<a href=\"#\" class=\"spinner-arrow-down\" tabindex=\"-1\"></a>");
...
(function( $ ) {
	...
	function _582( _583 ) {
		...
		var _58f = _58e + _588.children("div.datagrid-header")._outerHeight() + _588.children("div.datagrid-footer")._outerHeight()
	...
	function _6a8( _6a9, _6aa ) {
		 ...
		 * @author 26007
		 */
		if(opts.pagination && opts.insertRowOnly){
			var _copyRows = $.data(_6a9, "datagrid").insertedCopyRows;
			_copyRows.push(_6aa.row);
		}
	...
	function _6ac( _6ad, row ) {
		var opts = $(_6ad).datagrid("options");
		 ...
		 */
		if(opts.pagination && opts.insertRowOnly){
			var _copyRows = $.data(_6ad, "datagrid").insertedCopyRows;
			_copyRows.push(row);
		}
	...
	;
	var _6df = $.extend({}, _6d1([ "text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox",
	...
	$.fn.datagrid.parseOptions = function( _725 ) {
		var t = $(_725);
		return $.extend({}, $.fn.panel.parseOptions(_725), $.parser.parseOptions(_725, [ "url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition",
				"resizeHandle", {
	...
	var _728 = {
		...
		insertRow : function( _754, _755, row ) {
			...
			/**
		 	 * 当是分页状态下，如果插入的数据大于当前页长度，则将数据放入数据集，但不在界面上显示
		 	 * @author 26007
		 	 */
			if(opts.pagination && opts.insertRowOnly){
				var pagination = $(_754).datagrid("getPager");
				if((_755 + 1) > pagination.pagination("options").pageSize){
					data.total += 1;
	...
	$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
		insertRowOnly : false, //仅支持插入数据模式 26007
		...
		loader : function( _76c, _76d, _76e ) {
			...
			/**
			 * 当是分页状态时,如果插入拷备数据>0,则进行本地缓存数据分页操作
			 * @author 26007
			 */
			var _insertedCopyRows = $.data(this, "datagrid").insertedCopyRows;
			var _beginIndex = -1;
			var _endIndex = -1;
			
			if(opts.pagination && opts.insertRowOnly){
				var _pagination = $(this).datagrid("getPager");
				var _pagiOpts = _pagination.pagination("options");
				
				_beginIndex = (_pagiOpts.pageNumber - 1) * _pagiOpts.pageSize;
				_endIndex = _beginIndex + _pagiOpts.pageSize;
			}
			...
			} else if(opts.pagination && opts.insertRowOnly && _beginIndex > -1 && _endIndex > -1 && _insertedCopyRows.length > 0 && _insertedCopyRows.length > _beginIndex){
				var _tmpData = _insertedCopyRows.slice(_beginIndex, _endIndex > _insertedCopyRows.length ? _insertedCopyRows.length : _endIndex);
				var pager = {
					total : _insertedCopyRows.length,
					rows : _tmpData
				};
				_76d(pager);
			} else if (!opts.url) {
			...
			function _892( _893, _894, _895 ) {
				...
				for ( var i = 0; i < _895.length; i++) {
					...
					if (row.children && row.children.length) {
						...
						_898.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px\" colspan=" + (_88f.length + (opts.rownumbers ? 1 : 0))
								+ "><div style=\"display:" + v + "\">");
						_898 = _898.concat(tt);
						_898.push("</div></td></tr>");
					}
...
(function( $ ) {
	function _9af( _9b0 ) {
		...
		function _9b3( _9ba ) {
			...
			var _9bc = $("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>")
					.appendTo(_9bb);
			var tr = _9bc.find("tr");
			for ( var i = 0; i < opts.buttons.length; i++) {
				var td = $("<td></td>").appendTo(tr);
				var btn = opts.buttons[i];
				var t = $("<a class=\"datebox-button-a\" href=\"#\"></a>").html($.isFunction(btn.text) ? btn.text(_9ba) : btn.text).appendTo(td);
...
(function( $ ) {
	function init( _a00 ) {
		var _a01 = $(
				"<div class=\"slider\">" + "<div class=\"slider-inner\">" + "<a href=\"#\" class=\"slider-handle\"></a>" + "<span class=\"slider-tip\"></span>"
						+ "</div>" + "<div class=\"slider-rule\"></div>" + "<div class=\"slider-rulelabel\"></div>" + "<div style=\"clear:both\"></div>"
						+ "<input type=\"hidden\" class=\"slider-value\">" + "</div>").insertAfter(_a00);
		var t = $(_a00);
